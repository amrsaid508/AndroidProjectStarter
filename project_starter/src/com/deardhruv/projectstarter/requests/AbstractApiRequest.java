...
/** Base class for the API requests. Provides functionality for cancelling api requests. */
public abstract class AbstractApiRequest {
    ...
    /** 
     * Cancels the running request. The response will still be delivered but will be ignored.
     * The implementation should call invalidate on the callback which is used for the request.
     */
