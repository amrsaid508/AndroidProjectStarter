...
public class ImageListResponseEvent extends AbstractResponseEvent {
    ...
    /** 
     * Create a UpdateMessageResponseEvent with a valid response object. The object can still
    ...
    /**
     * Create a AppMessageResponseEvent with a {@link RetrofitError} object. This means that the
     * api request failed with a severe error and no valid xml could be retrieved.
     *  
